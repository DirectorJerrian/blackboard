"use strict";
cc._RF.push(module, 'c0e81aNCixOf5LDJaxL3kfg', 'bar');
// bar.js
...
cc.Class({
    ...
    onLoad: function onLoad() {
        ...
        if (account.getid() == null) {
            ...
            _http.get("/activity/private/" + account.getid(), {}, function (res) {
                var j = 1;
                ...
                for (var i = 0; i < res.data.length; i++) {
                    ...
                    newEvent.getComponentsInChildren(cc.Label)[1].string = "● Time:" + time1 + "~" + time2;
                    ...
                    newEvent.setPosition(cc.v2(50, -300 - i * 180));
                }
