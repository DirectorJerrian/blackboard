...
const url = "http://47.101.187.188:8888"; //服务器地址
...
cc.Class({
    ...
    register: function(path,params,callBack){
    ...
    login: function(path,params,callBack){
        var  requestUrl = url + path;
            var xhr = cc.loader.getXMLHttpRequest();
            // var data=self.paramData(params);
            var data = params;
    ...
    addActivities: function(path,params,callBack){
        var  requestUrl = url + path;
            var xhr = cc.loader.getXMLHttpRequest();
            // var data=self.paramData(params);
            var data = params;
    ...
    addExistedActivities: function(path,params,callBack){
    ...
    updateActivities: function(path,params,callBack){
        var  requestUrl = url + path; 
            var xhr = cc.loader.getXMLHttpRequest();
            // var data=self.paramData(params);
            var data = params;
    ...
    addOrJoin: function(path,params,callBack){
        var  requestUrl = url + path;
            var xhr = cc.loader.getXMLHttpRequest();
            // var data=self.paramData(params);
            var data = params;
